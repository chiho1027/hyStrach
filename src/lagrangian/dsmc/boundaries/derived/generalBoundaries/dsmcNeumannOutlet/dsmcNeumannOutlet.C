...
defineTypeNameAndDebug(dsmcNeumannOutlet, 0);

addToRunTimeSelectionTable(dsmcGeneralBoundary, dsmcNeumannOutlet, dictionary);
...
dsmcNeumannOutlet::dsmcNeumannOutlet
(
    Time& t,
    const polyMesh& mesh,
    dsmcCloud& cloud,
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void dsmcNeumannOutlet::initialConfiguration()
{}

void dsmcNeumannOutlet::calculateProperties()
{
}

void dsmcNeumannOutlet::controlParcelsBeforeMove()
{    
    //////////////////////////////////////////////////////////////////////
  /*
    if(nTimeSteps_ == 0)
...
void dsmcNeumannOutlet::controlParcelsBeforeCollisions()
{
    
}

void dsmcNeumannOutlet::controlParcelsAfterCollisions()
{    
    nTimeSteps_ += 1.0;
...
void dsmcNeumannOutlet::updateProperties(const dictionary& newDict)
{
...
void dsmcNeumannOutlet::setProperties()
{
    ...
    if(molecules.size() == 0)
    {
        FatalErrorIn("dsmcNeumannOutlet::setProperties()")
    ...
    forAll(moleculesReduced, i)
    {
        ...
        if(typeId == -1)
        {
            FatalErrorIn("dsmcNeumannOutlet::dsmcNeumannOutlet()")
...
void dsmcNeumannOutlet::setNewBoundaryFields()
{
  /*
